...
mod tests {
    ...
    fn encode_rfc9292_request_example_indeterminate_length() {
        // This example is modified from Section 5.1 of RFC 9292 - Indeterminate-Length Binary Encoding of Request
        //
        ...
        const REQUEST_EXAMPLE: &[u8] = &[
            ...
            0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x74, 0x78, 0x74, 0x0a, 0x75, 0x73, 0x65,
            0x72, 0x2d, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x34, 0x63, 0x75, 0x72, 0x6c, 0x2f, 0x37,
            0x2e, 0x31, 0x36, 0x2e, 0x33, 0x20, 0x6c, 0x69, 0x62, 0x63, 0x75, 0x72, 0x6c, 0x2f,
            0x37, 0x2e, 0x31, 0x36, 0x2e, 0x33, 0x20, 0x4f, 0x70, 0x65, 0x6e, 0x53, 0x53, 0x4c,
            0x2f, 0x30, 0x2e, 0x39, 0x2e, 0x37, 0x6c, 0x20, 0x7a, 0x6c, 0x69, 0x62, 0x2f, 0x31,
        ...
        let request = Request::builder()
            .method("GET")
            .uri("https://www.example.com/hello.txt")
            .header(
                "user-agent",
